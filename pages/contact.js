...
export default (props) => {
    ...
    return (
        <>
            {/* <div className="fixed-top px-3 text-right" style={{backgroundColor: "#fffff0"}}>
           ...
           <Link href="/contact"><a style={{color: "#000000"}}>Contact</a></Link>
                {user._id
            ...
            <div className="text-right" style={{backgroundColor: "#ffffff", margin:0}}>
